...
const PERM = {
  owner:     { fin:true,  del:true,  usr:true  },
  principal: { fin:true,  del:false, usr:false },
  bursar:    { fin:true,  del:false, usr:false },
  teacher:   { fin:false, del:false, usr:false },
};
